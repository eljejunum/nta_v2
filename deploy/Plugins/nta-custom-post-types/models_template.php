<?php
/**
 * Template Name: NTA Model Template
 * The main template file for displaying model profile.
 *
 * @package WordPress, Core Photography Theme, RWMB Meta
 */
...
?>
	...
	<div class="model_container">
		...
		<div class="model_info">
			...
			<p class="model_stats">
				Height: <?php echo rwmb_meta( 'NTA_height');?><br/>
				Waist: <?php echo rwmb_meta( 'NTA_waist');?><br/>
				Shoes: <?php echo rwmb_meta( 'NTA_shoes');?><br/>
				Hair: <?php echo rwmb_meta( 'NTA_hair');?><br/>
				Eyes: <?php echo rwmb_meta( 'NTA_eyes');?><br/>
						
				<?php if(rwmb_meta('NTA_gender') == 'value1'): ?>
					Suit: <?php echo rwmb_meta( 'NTA_bust-suit');?><br/>
					Suit Length: <?php echo rwmb_meta( 'NTA_cup-length');?><br/>
					Shirt: <?php echo rwmb_meta( 'NTA_hips-shirt');?><br/>
					Shirt Sleeve <?php echo rwmb_meta( 'NTA_dress-sleeve');?><br/>
					Inseam: <?php echo rwmb_meta( 'NTA_inseam');?>
				<?php endif; ?>
				<?php if(rwmb_meta('NTA_gender') == 'value2'): ?>
					Bust: <?php echo rwmb_meta( 'NTA_bust-suit');?><br/>
					Cup: <?php echo rwmb_meta( 'NTA_cup-length');?><br/>
					Hips: <?php echo rwmb_meta( 'NTA_hips-shirt');?><br/>
					Dress: <?php echo rwmb_meta( 'NTA_dress-sleeve');?><br/>
				<?php endif ?>
			</p>
			<div id="instructions">
				<p>
					Use your mousewheel, trackpad, <br/>
					swipe, or click the next image <br/>
